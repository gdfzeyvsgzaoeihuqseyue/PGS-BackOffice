module.exports = {
  ...
  description: 'Récupérer la liste de tous les utilisateurs avec pagination',
  ...
  fn: async function(inputs, exits) {
    try {
      ...
      // Compter le total
      const totalUsers = await User.count(criteria);
      ...
      return exits.success({
        ...
        pagination: {
          ...
          limit: inputs.limit,
          total: totalUsers,
          totalPages: Math.ceil(totalUsers / inputs.limit)
        }
      });
