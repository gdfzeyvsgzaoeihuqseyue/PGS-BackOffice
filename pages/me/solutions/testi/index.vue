...
const { testimonies, loading, error, pagination } = storeToRefs(testimonyStore)

// Load init data
const refresh = () => {
  testimonyStore.fetchTestimonies(pagination.value.page)
}

const changePage = (page) => {
  if (page > 0 && page <= pagination.value.totalPages) {
    testimonyStore.fetchTestimonies(page)
  }
}
