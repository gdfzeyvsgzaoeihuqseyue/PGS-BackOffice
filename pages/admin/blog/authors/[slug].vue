<template>
  <div v-if="author">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 max-w-2xl mx-auto text-center">
      <img :src="author.avatar" class="w-32 h-32 rounded-full mx-auto mb-6 border-4 border-slate-50" />
