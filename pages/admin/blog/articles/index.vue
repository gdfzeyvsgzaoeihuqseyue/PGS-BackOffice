<template>
  <div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center text-slate-500">
      <IconArticle size="48" class="mx-auto text-slate-300 mb-4" />
      <p>Fonctionnalité en cours de développement.</p>
      <p class="text-sm">Le store et les types sont prêts.</p>
    </div>
  </div>
</template>

<script setup>
import { IconArticle, IconPlus } from '@tabler/icons-vue'
