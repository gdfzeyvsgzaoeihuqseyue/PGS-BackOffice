module.exports = {
  ...
  fn: async function (inputs, exits) {
    try {
      ...
      // Le hashage du mot de passe est géré par le cycle de vie du modèle (beforeUpdate)
      const updateData = {
      ...
      // Logger l'activation (optionnel, sans adminId car pas encore connecté, ou alors on considère que c'est une action système)
      // Si on veut logger, on peut le faire au nom du nouvel admin
