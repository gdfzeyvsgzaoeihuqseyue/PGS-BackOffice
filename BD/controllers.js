module.exports = {
  ...
  fn: async function (inputs, exits) {
    try {
      ...
      // Traiter le paramètre populate si fourni, sinon peupler toutes les relations par défaut
      if (inputs.populate) {
        ...
        // Liste par défaut des relations à peupler
        populateRelations = [
          'docs',
          'faqTopics',
          'tutorials',
          ...
          'partners',
          'testimonies'
        ].filter(rel => allowedPopulations.includes(rel));
      }
