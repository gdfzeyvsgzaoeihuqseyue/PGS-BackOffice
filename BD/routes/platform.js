module.exports = {
  ...
  'PUT /api/v1/solution/platform/:id': {
  ...
  'DELETE /api/v1/solution/platform/:id': {
  ...
  'GET /api/v1/solution/platform/:identifier': {
